...
async def new_songs_for_you():
    try:
        ...
        select_statement = select([request_table.c.id, request_table.c.email, request_table.c.state, request_table.c.songid]).where(request_table.c.state == "ready")
        ...
        with engine.connect() as conn:
            ...
            for row in result:
                ...
                response = send_simple_message(responseData, email)
                ...
                update_statement_service_3 = (
                    ...
                    .values(state="done")  # Set the new values for the columns
                )
